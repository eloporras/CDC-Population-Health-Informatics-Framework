...
CREATE TABLE question_answer (
  ...
  isType int NOT NULL,
  hasSubAnswer int NOT NULL,
  hasSubQuestion int NOT NULL,
...
(21, 6, 'Code age in years', 1, 1, 0, 0, 0, '0'),
...
(60, 13, 'ANSI County Code (formerly FIPS county code)', 1, 0, 0, 0, 0, '0'),
(61, 13, 'Don''t know / Not sure', 2, 0, 0, 0, 0, '777'),
(62, 13, 'Refused', 3, 0, 0, 0, 0, '999'),
(63, 14, 'ZIP Code', 1, 0, 0, 0, 0, '0'),
...
(89, 20, 'Number of children', 1, 1, 0, 0, 0, '0'),
...
(104, 23, 'Weight(pounds/kilograms)', 1, 1, 0, 0, 0, '0'),
(105, 23, 'Don''t know / Not sure', 2, 0, 0, 0, 0, '7777'),
(106, 23, 'Refused', 3, 0, 0, 0, 0, '9999'),
(107, 24, 'Height(ft/inches/meters/centimeters)', 1, 1, 0, 0, 0, ''),
